...
#[tauri::command]
pub fn list_folders(app_handle: tauri::AppHandle, class_id: Option<i64>) -> Result<Vec<Folder>, String> {
...
pub fn delete_folder(
	...
	let conn = storage::db::get_conn(&app_handle).map_err(|e| e.to_string())?;
	storage::folders::delete_folder(&conn, folder_id).map_err(|e| e.to_string())
}
